...
namespace Terrasoft.Configuration.ServicePactService
{
	...
	/// <summary>
	/// Утилитный клас для нахождения подходящих сервисных договоров.
	/// </summary>
	public class ServicePactDetermineUtilsV2
	{
		...
		/// <summary>
		/// Возвращает массив подходящих сервисных договоров. Договора определяются на основании
		/// объектов обслуживания указанных Контакта и Контрагента.
		/// </summary>
		/// <param name="request">Запрос на определение договоров</param>
	...
	/// <summary>
	/// Предстваляет расширения для классов, которые относятся к определению подходящих сервисных договоров.
	/// </summary>
	public static class SuitableServicePactExtensions
	{
		...
		/// <summary>
		/// Возвращает объект подходящего сервисного договора на основе сущности, полученой из БД.
		/// </summary>
		/// <param name="serviceObject">Сущность Сервисный договор</param>
		/// <param name="suitableLevel">Показатель наколько подходит данный сервисный договор</param>
		/// <returns>Объект подходящего сервисного договора</returns>
